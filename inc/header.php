<?php
// ! index.php ' ye güvenlik için koyduk eğer ki defined tanımlanmamışsa yani index'ten gelmiyorsak çalışmıcak
...
<head>
    ...
    <!--
    Burdaki $title['title'] function.php ' deki title'dan geliyor
    bu sayede google'da üstteki barda hangi sayfaya gidersek onun ismi yazıyor
    -->
    ...
    <meta name="twitter:creator" content="B2B">
