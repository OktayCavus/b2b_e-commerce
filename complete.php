				...
				<div class="col-md-12">
					<div class="heading-banner">
						<div class="heading-banner-title">
							<h2>Siparişiniz İçin Teşekkürler</h2>
						</div>
						<div class="breadcumbs pb-15">
							<ul>
								<li><a href="<?php echo site; ?>">Ana Sayfa</a></li>
								<li>Siparişiniz İçin Teşekkürler</li>
							</ul>
						</div>
					</div>
				</div>
		...
		<div class="container">
			<div class="thankyour-area bg-white mb-30">
				<div class="row">
					<div class="col-md-12">
						<div class="thankyou">
							<h2 class="text-center mb-0">Siparişiniz için teşekkür ederiz <a href="<?php echo site; ?>/order"> siparişlerinize dönmek için tıklayınız.</a></h2>
						</div>
					</div>
				</div>
			</div>
